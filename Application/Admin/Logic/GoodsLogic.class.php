...

{
...

    {
        ...
        $GoodsAttribute = D('GoodsAttribute');//实例化商品属性
            ...
            {                                        
                           ...
                           //     $str .= "<input type='hidden' name='goods_attr_id[]' value='{$v['goods_attr_id']}'/>";
...

                            {
                                ...
                                $str .= "<input class='input-text' type='text' size='40' value='{$v['attr_value']}' name='attr_{$val['attr_id']}[]' />";
...

                            {
                                ...
                                $str .= "<select class='select' name='attr_{$val['attr_id']}[]'>";

                                $tmp_option_val = explode("\n", $val['attr_values']);
...

                            {
                                ...
                                $str .= "<textarea class='textarea' cols='40' rows='3' name='attr_{$val['attr_id']}[]'>{$v['attr_value']}</textarea>";
     ...
     * 获取 tp_goods_attr 表中指定 goods_id  指定 attr_id  或者 指定 goods_attr_id 的值 可以是字符串 可以是数组
...

    {
       ...
       $str = "<table class='table table-border table-bordered radius table-hover' id='spec_input_tab'>";
...

       {
            ...
            $str .="<td><input class='input-text' name='item[$item_key][price]' value='{$keySpecGoodsPrice[$item_key][price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' /></td>";

            $str .="<td><input class='input-text' name='item[$item_key][store_count]' value='{$keySpecGoodsPrice[$item_key][store_count]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")'/></td>";            

            $str .="<td><input class='input-text' name='item[$item_key][sku]' value='{$keySpecGoodsPrice[$item_key][sku]}' />
