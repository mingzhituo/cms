...
function getAllMenu(){
	...
	return	array(
			...
			'system' => array('name'=>'系统设置','icon'=>'&#xe62e;','sub_menu'=>array(
			...
			'access' => array('name' => '权限管理', 'icon'=>'&#xe63c;', 'sub_menu' => array(
			...
			'goods' => array('name' => '商品管理', 'icon'=>'&#xe620;', 'sub_menu' => array(
			...
			/*'promotion' => array('name' => '促销管理', 'icon'=>'&#xe6ca;', 'sub_menu' => array(
			...
			'Ad' => array('name' => '图片管理', 'icon'=>'&#xe6bb;', 'sub_menu' => array(

					array('name' => '图片列表', 'act'=>'adList', 'control'=>'Ad'),

					array('name' => '图片位置', 'act'=>'positionList', 'control'=>'Ad'),

				)),

			'content' => array('name' => '内容管理', 'icon'=>'&#xe616;', 'sub_menu' => array(

					array('name' => '文章列表', 'act'=>'articleList', 'control'=>'Article'),

					array('name' => '文章分类', 'act'=>'categoryList', 'control'=>'Article'),

					array('name' => '留言管理', 'act'=>'message_list', 'control'=>'Article'),
			...
			// 'weixin' => array('name' => '微信管理', 'icon'=>'product', 'sub_menu' => array(
			...
			'tools' => array('name' => '文件管理', 'icon'=>'&#xe60e;', 'sub_menu' => array(

					array('name' => '文件列表', 'act'=>'index', 'control'=>'Files'),
...
{     
    ...
    $vaules = array(            
     ...
     $url = "http://Home&c=Index&a=user_push&".http_build_query($vaules);
