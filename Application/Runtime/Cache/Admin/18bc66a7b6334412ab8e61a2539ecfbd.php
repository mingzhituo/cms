...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单 <span class="c-gray en">&gt;</span> 订单列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="col-xs-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title" style="padding:0px;"><i class="Hui-iconfont">&#xe681;</i> 订单列表</h3>
        </div>
        <div class="page-container">        
            <div class="navbar navbar-default">
                <!-- <form action="<?php echo U('Order/index');?>" id="search-form2" class="navbar-form form-inline col-sm-5 l" method="post">
                ...
                <span class="r mt-10 mr-20"> <a href="javascript:;" onclick="admin_add('添加图片','<?php echo U("Admin/Ad/ad_info");?>','1000','800')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加订单</a></span>  -->
            </div>
            <table class="table table-border table-bordered radius table-hover" id="list-table" style="border-collapse:collapse;">
                ...
                <tbody>
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="text-c">
                        <td class="va-m"><?php echo ($vo['company']); ?></td>
                        <td class="va-m"><?php echo ($vo['consignee']); ?></td>
                        <td class="va-m"><?php echo ($vo["mobile"]); ?></td>
                        <td class="va-m"><?php echo ($vo["phone"]); ?></td>
                        <td class="va-m"><?php echo ($vo["fax"]); ?></td>
                        <td class="va-m">
                            <?php echo ($vo["email"]); ?>                      
                        </td>
                        <td class="va-m">
