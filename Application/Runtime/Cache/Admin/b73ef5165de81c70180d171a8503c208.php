    ...
    <div class="panel panel-default">
        ...
        <div class="page-container">        
            <div class="navbar navbar-default">
				<form action="" id="search-form2" class="navbar-form form-inline l" method="post" style="width:80%" onsubmit="return false">
					<div class="formControls">
						...
						<select name="cat_id" id="cat_id" class="select">
							...
							<?php if(is_array($categoryList)): foreach($categoryList as $k=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if($v['id'] == $catid): ?>selected<?php endif; ?>> <?php echo ($v['name']); ?></option><?php endforeach; endif; ?>
						</select>
						</span>
            	...
            	<span class="r mt-10 mr-20"> <a href="javascript:;" onclick="admin_add('添加商品','<?php echo U("Admin/Goods/goods");?>','1000','800')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a></span> 
            </div>
