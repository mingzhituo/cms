...
<div class="col-xs-12">
    <div class="panel panel-default">
        ...
        <div class="page-container">
            <div class="navbar navbar-default"> <span class="r mt-10 mr-20"> <a href="javascript:;" onclick="admin_add('添加角色','<?php echo U("Admin/Admin/role_info");?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a></span> </div>
            <table class="table table-border table-bordered radius table-hover" id="list-table" style="border-collapse:collapse;">
                ...
                <tbody>
                    <?php if(is_array($list)): foreach($list as $key=>$vo): if($vo['role_id'] > 0): ?><tr class="text-c">
                        <td class="va-m"><?php echo ($vo["role_id"]); ?></td>
                        <td class="va-m"><?php echo ($vo["role_name"]); ?></td>
                        <td class="va-m"><?php echo ($vo["role_desc"]); ?></td>
                        <td>
                            <a title="编辑" href="javascript:;" onclick="admin_edit('角色编辑','<?php echo U("Admin/Admin/role_info/role_id/".$vo['role_id']);?>','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont btn btn-info radius">&#xe6df;</i></a>
                            <a title="删除" href="javascript:;" onclick="admin_del('<?php echo U("Admin/Admin/roleHandle");?>',this,<?php echo ($vo['role_id']); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont btn btn-danger radius">&#xe6e2;</i></a>
                        </td>
