    ...
    <form class="form form-horizontal" action="" method="post" id="form-admin-add">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="<?php echo U('Admin/Admin/captcha');?>" id="img" onclick="refresh()"> <a id="kanbuq" href="javascript:;" onclick="refresh()">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
...
<script type="text/javascript">
	function refresh () {
		var src = '/index.php/Admin/Admin/captcha/rand/'+Math.random()*10000000;
		$('#img').attr('src',src);
	}
	$(function(){
