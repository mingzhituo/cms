...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 文件 <span class="c-gray en">&gt;</span> 文件列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="col-xs-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title" style="padding:0px;"><i class="Hui-iconfont">&#xe681;</i> 文件列表</h3>
        </div>
        <div class="page-container">        
            <div class="navbar navbar-default">
				<form action="<?php echo U('Ad/adList');?>" id="search-form2" class="navbar-form form-inline col-sm-5 l" method="post">
					<div class="formControls col-sm-12" style="width:500px;">
						<span class="select-box" style="width:32%;">
							<input type="text" name="keywords" placeholder="请输入图片名称" style="border:0 none;">
						</span>
            	...
            	<span class="r mt-10 mr-20"> <a href="javascript:;" onclick="admin_add('添加图片','<?php echo U("Admin/Files/info");?>','800','600')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 上传文件</a></span> 
            </div>
            <table class="table table-border table-bordered radius table-hover" id="list-table" style="border-collapse:collapse;">
                ...
                <tbody>
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="text-c">
                        <td class="va-m"><?php echo ($vo["file_name"]); ?></td>
                        <td class="va-m"><img alt="" src="<?php echo ($vo["file_img"]); ?>" width="80px" height="50px"></td>
                        <td class="va-m"><?php echo ($vo["file_url"]); ?></td>
                        <td class="va-m">
                        	<a title="编辑" href="javascript:;" onclick="admin_edit('文件信息编辑','<?php echo U("Admin/Files/edit/time/".$vo['up_time']);?>','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont btn btn-info radius">&#xe6df;</i></a>
                            <a title="删除" href="javascript:;" onclick="admin_del('<?php echo U("Admin/Files/del_file/time/".$vo['up_time']);?>',this,<?php echo ($vo['ad_id']); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont btn btn-danger radius">&#xe6e2;</i></a>
                        </td>
