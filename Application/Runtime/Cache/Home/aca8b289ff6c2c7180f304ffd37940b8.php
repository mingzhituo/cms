...
<!--  data-toggle="dropdown"  dropdown-toggle -->
  ...
  <div class="subcolumn_nav_met_21_1_39" m-id='39' m-type='nocontent'>
    ...
    <!-- <div class="location_met_21_1_50 met-crumbs" m-id='50'>
      ...
      <main class="news_list_detail_met_16_1_51 met-shownews animsition     left">
        <div class="container">
          <div class="row sm0">
            <div class="col-md-9 met-shownews-body" m-id='51'>
              <div class="row">
                <section class="details-title border-bottom1">
                  <h1 class='m-0'><?php echo ($on["title"]); ?></h1>
                ...
                <div class='met-page p-y-30 border-top1'>
                  <div class="container p-t-30 ">
                    <ul class="pagination block blocks-2"'>
                      ...
                      <?php if($prev == ''): ?><li class=' page-item m-b-0 '>
            <a href='#'
                     title="<?php echo ($on["title"]); ?>" class='page-link text-truncate'>
                      上一页 <span aria-hidden="true" class='hidden-xs-down'>暂无</span>
         </a>
        </li>
        <?php else: ?>
          <li class=' page-item m-b-0 '>
            <a href='<?php echo U(''.CONTROLLER_NAME.'/page',array('id'=>$prev['article_id']));?>'
                     title="<?php echo ($on["title"]); ?>" class='page-link text-truncate'>
                      上一页 <span aria-hidden="true" class='hidden-xs-down'><?php echo ($prev["title"]); ?></span>
         </a>
        </li><?php endif; ?>



                   <?php if($next == ''): ?><li class='page-item m-b-0 '>
                        <a href='#' title="暂无" class='page-link pull-xs-right text-truncate'>
                          下一页 <span aria-hidden="true" class='hidden-xs-down'>: 暂无</span>
                        </a>
                      </li>
                       <?php else: ?>
                         <li class='page-item m-b-0 '>
                        <a href='<?php echo U(''.CONTROLLER_NAME.'/page',array('id'=>$next['article_id']));?>' title="<?php echo ($next["title"]); ?>" class='page-link pull-xs-right text-truncate'>
                          下一页 <span aria-hidden="true" class='hidden-xs-down'>: <?php echo ($next["title"]); ?></span>
                        </a>
                      </li><?php endif; ?>
